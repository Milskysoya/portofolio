    ...
    function processCommand(cmd) {
        ...
        switch (cmd) {
            case 'help':
                ...
                break;
            case 'whoami':
                response = "velasco_dendy\n(Undergraduate Electrical Engineering Student | Cybersecurity Enthusiast)";
                break;
            case 'ls skills':
            case 'ls': // flexible
            ...
            case 'cat about': // flexible
                response = "Saya adalah Undergraduate Electrical Engineering student at Universitas Brawijaya. Memiliki ketertarikan mendalam pada dunia Cybersecurity, Networking, dan Technology. Saat ini saya sedang fokus mempelajari sistem operasi Linux (terutama Arch dan Kali) serta mendalami konsep keamanan sistem jaringan.";
                break;
            case 'clear':
